...
#define CONFIG_SYS_MEMTEST_END		(CONFIG_SYS_SDRAM_BASE + 0x40000000)
...
#define BL0_SIZE			    (8 << 10)   /*8 K reserved for BL0*/
#define BL1_SIZE			    (16 << 10)  /*16 K reserved for BL1*/
#define CONFIG_ENV_OFFSET		(RESERVE_BLOCK_SIZE + BL1_SIZE + BL0_SIZE)
